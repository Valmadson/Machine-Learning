...
def rhymeindex(lyrics):
    '''
            ...
            -------
            TYPE
                    Retorna uma lista com o final das palavras.
    '''
    if str(artist) + ".rhymes" in os.listdir(".") and train_mode == False:
        ...
        for i in lyrics:
            ...
            try:
                rhymescheme = max(set(rhymeslistends),
                                  key=rhymeslistends.count)
            except Exception:
                rhymescheme = word[-2:]
...
def split_lyrics_file(text_file):
    '''
            Parameters
            ----------
            text_file : Localização e nome do arquivo texto
                    Recebe um arquivo que será fitado.

            Returns
            -------
            text : TYPE
                    Retorna o texto com todos os espaços removidos.
    '''
...
def build_dataset(lines, rhyme_list):
    """
            ...
            ----------
            lines : TYPE
                    Recebe uma lista contendo o texto das rimas.
            rhyme_list : TYPE
                    Recebe uma lista contendo uma lista da finalização das palavras .
...
def main(depth, train_mode):
    model = create_network(depth)  # Criação da rede neural recorrente
    text_model = markov(text_file)  # Criação da lista de markov
    if train_mode == True:
        # devolve lista com espaços removidos
    ...
    if train_mode == True:
        print('bars', bars)
        print('rhyme lista', rhyme_list)
        # passa cada linha do cordel com a finalização das palavras
